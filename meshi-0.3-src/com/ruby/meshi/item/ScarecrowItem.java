   ...
   public ActionResultType func_195939_a(ItemUseContext context) {
     ...
     if (blockitemusecontext.func_196011_b() && world.func_180495_p(blockpos1).func_196953_a(blockitemusecontext)) {
       ...
       if (!world.field_72995_K) {
         ...
         float f = MathHelper.func_76141_d((MathHelper.func_76142_g(context.func_195990_h() - 180.0F) + 22.5F) / 45.0F) * 45.0F;
         scarecrowEntity.func_70012_b(d0 + 0.5D, d1, d2 + 0.5D, f, 0.0F);
         applyRandomRotations(scarecrowEntity, world.field_73012_v);
         EntityType.func_208048_a(world, context.func_195999_j(), (Entity)scarecrowEntity, itemstack.func_77978_p());
         world.func_217376_c((Entity)scarecrowEntity);
