   ...
   extends Item
 {
  ...
  public IItemTier getTier() {
   ...
   public ActionResult<ItemStack> func_77659_a(World worldIn, PlayerEntity playerIn, Hand handIn) {
     ...
     if (!worldIn.field_72995_K) {
       ...
       entity.func_184547_a((Entity)playerIn, playerIn.field_70125_A, playerIn.field_70177_z, 0.0F, 0.8F, 5.0F);
  ...
  public float getAttackDamage(ItemStack itemStack) {
   ...
   public void func_77624_a(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
     tooltip.add((new TranslationTextComponent("attribute.modifier.plus." + AttributeModifier.Operation.ADDITION.func_220371_a(), new Object[] { ItemStack.field_111284_a.format(getAttackDamage(stack)), new TranslationTextComponent("tooltip.meshi.throwing_damage", new Object[0]) })).func_211708_a(TextFormatting.DARK_GREEN));
   }
 }
