...
public class MillstoneScreen extends ContainerScreen<MillstoneContainer> implements IRecipeShownListener {
   ...
   public MillstoneScreen(MillstoneContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
     ...
     this.book = new GrindRecipeBookGui();
   }
   ...
   public void init() {
     ...
     func_212928_a((IGuiEventListener)this.book);
        addButton((Widget)new ImageButton(this.field_147003_i + 20, this.height / 2 - 49, 20, 18, 0, 0, 19, BOOK_BUTTON, button -> {
   ...
   protected void func_146976_a(float partialTicks, int mouseX, int mouseY) {
     ...
     blit(k, l, 0, 0, this.field_146999_f, this.field_147000_g);
        int progress = ((MillstoneContainer)func_212873_a_()).getProgress();       
     
     blit(k + 80, l + 46, 192, 6 * getRatio((((MillstoneContainer)func_212873_a_()).getGrindtime() - progress), ((MillstoneContainer)func_212873_a_()).getGrindtime()), 16, 6);
   }
