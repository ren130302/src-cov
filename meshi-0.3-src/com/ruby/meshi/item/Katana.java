...
import java.util.UUID;
   ...
   implements KatanaDrop.KatanaDropListener
 {
   ...
   public Katana(Item.Properties builder) {
     super((IItemTier)ItemTier.IRON, 3, -2.0F, builder);
     func_185043_a(new ResourceLocation("blocking"), (stack, world, entity) ->        (entity != null && entity.func_184587_cr() && entity.func_184607_cu() == stack) ? 1.0F : 0.0F);    
     eventBusInit();
   }
  public void eventBusInit() {
   ...
   public ItemStack func_77654_b(ItemStack stack, World worldIn, LivingEntity entityLiving) {
     if (entityLiving instanceof PlayerEntity) {
       ((PlayerEntity)entityLiving).func_184811_cZ().func_185145_a((Item)this, 20);
     }
   ...
   public void func_77615_a(ItemStack stack, World worldIn, LivingEntity entityLiving, int timeLeft) {
     if (entityLiving instanceof PlayerEntity) {
       ((PlayerEntity)entityLiving).func_184811_cZ().func_185145_a((Item)this, 20 + timeLeft);
     }
   }
   ...
   public void onUsingTick(ItemStack stack, LivingEntity player, int count) {
     ...
     if (world.field_72995_K)
     {
       if (isReflect(count)) {
         ...
         eyeVec = eyeVec.func_72441_c(player.field_70165_t, player.field_70163_u + player.func_70047_e(), player.field_70161_v);
         ...
         vec = Vec3d.func_189984_a(player.func_189653_aC());
                world.func_195594_a((IParticleData)ParticleTypes.field_197614_g, eyeVec.field_72450_a, eyeVec.field_72448_b, eyeVec.field_72449_c, randX, randY, randZ);      } 
     }
   }
   ...
   public ActionResult<ItemStack> func_77659_a(World worldIn, PlayerEntity playerIn, Hand handIn) {
     if (!worldIn.field_72995_K && playerIn instanceof net.minecraft.entity.player.ServerPlayerEntity) {
            ItemStack offStack = playerIn.func_184586_b(Hand.OFF_HAND);
       if (offStack.func_190926_b() || isKatana(offStack) || offStack.func_77973_b() instanceof net.minecraft.item.BlockItem) {
  ...
  public void onReflect(LivingAttackEvent event) {
     ...
     if (source != null && entity != null) {
       ...
       if (!world.field_72995_K &&        isKatana(entity.func_184607_cu())) {
         Entity sourceEntity = source.func_76364_f();
         if (sourceEntity != null) {
           if (isReflect(entity.func_184605_cv())) {
             ...
             if (sourceEntity instanceof IProjectile && source.func_76352_a()) {
               ...
               ((IProjectile)reflectEntity).func_70186_c(vector3f.func_195899_a(), vector3f.func_195900_b(), vector3f.func_195902_c(), 1.6F, 0.0F);
               ...
               if (entity instanceof PlayerEntity) {
                 ...
                 int pCount = (int)(attackedTargetHealth * 0.5D);
                 ((ServerWorld)world).func_195598_a((IParticleData)ParticleTypes.field_197615_h, sourceEntity.field_70165_t, sourceEntity.field_70163_u + (sourceEntity.func_213302_cg() * 0.5F), sourceEntity.field_70161_v, pCount, 0.1D, 0.0D, 0.1D, 0.2D);
               }                           isReflected = true;            }             if (isReflected && 
               entity instanceof PlayerEntity) {
               double d0 = -MathHelper.func_76126_a(entity.field_70177_z * 0.017453292F);
               double d1 = MathHelper.func_76134_b(entity.field_70177_z * 0.017453292F);
               ((ServerWorld)world).func_195598_a((IParticleData)ParticleTypes.field_197603_N, entity.field_70165_t + d0, entity.field_70163_u + entity.func_213302_cg() * 0.75D, entity.field_70161_v + d1, 0, d0, 0.0D, d1, 0.0D);
   ...
   public void onAttack(CriticalHitEvent event) {
     PlayerEntity player = event.getPlayer();
        if (isTwoHanded((LivingEntity)player)) {      
       event.setDamageModifier(getCritRate(event.getTarget()));
       event.setResult(Event.Result.ALLOW);
     }  }
   public float getCritRate(Entity entity) {
     float mod = 1.5F;
       if (entity instanceof net.minecraft.entity.monster.SlimeEntity || entity instanceof net.minecraft.entity.passive.CatEntity || entity instanceof net.minecraft.entity.passive.OcelotEntity) {
       mod = 0.0F;
     } else if (entity instanceof net.minecraft.entity.monster.ZombieEntity || entity instanceof net.minecraft.entity.monster.CreeperEntity || entity instanceof net.minecraft.entity.monster.SpiderEntity) {
       mod = 2.0F;
     } else if (entity instanceof net.minecraft.entity.passive.AnimalEntity) {
       mod = 4.0F;
     } else if (entity instanceof net.minecraft.entity.monster.SkeletonEntity) {
       mod = 1.0F;
     } else if (entity instanceof net.minecraft.entity.monster.BlazeEntity) {
       mod = 0.7F;
     } else if (entity instanceof net.minecraft.entity.passive.GolemEntity) {
       mod = 0.1F;
     }    return mod;
   }
  public boolean isTwoHanded(LivingEntity entity) {
     return (isKatana(entity.func_184614_ca()) && entity.func_184592_cb().func_190926_b());
   }

   public boolean canKatanaDrop(LivingEntity source, LivingEntity target, ItemStack stack, Hand hand) {
     return isTwoHanded(source);
   }
 }
