...
public class InfinityThrow
   extends Enchantment
 {
   protected InfinityThrow(Enchantment.Rarity rarityIn, EnchantmentType type, EquipmentSlotType... slots) {
   ...
   public boolean func_77326_a(Enchantment ench) {
     return (ench instanceof net.minecraft.enchantment.MendingEnchantment || ench instanceof EconomyBracelet || ench instanceof ReturnThrow) ? false : super.func_77326_a(ench);
   }
 }
